...
ADAPTERS = WORK / "lora_adapters_gemma4_car_repair"
LOGS = WORK / "logs"
...
BASELINE_ANSWERS = BASELINE_DIR / "baseline_answers.json"
BASELINE_SCORES = BASELINE_DIR / "baseline_scores.json"
...
# ============================================================
# CELL 9 — Append pre-render section AFTER model/LoRA setup
# ============================================================
# (existing cell 9 above: model loading, LoRA attach, memory report)
# ADD THIS BLOCK AT THE END:

# --- Pre-render chat text into 'text' column ---
...
# Render train and val sets
train_ds = train_ds.map(
    render_row,
    remove_columns=["messages"],   # drop raw messages, keep only text
...
metadata = {
    ...
    "results": {
        "final_train_loss_avg": 5.6562,
        "final_step_train_loss": 2.931,
        "final_eval_loss": 2.233,
        "total_steps": 32,
        "train_runtime_min": 5.5,
    },
    "data": {
        "train_size": 252,
        "val_size": 29,
        "total_source_samples": 281,
        "source": CONFIG.dataset_repo,
    },
    "notes": "First training run. Dataset size (281) is at low end of recommended range (500-5000). Post-eval will determine if retrain with more epochs is needed.",
}
...
zip_path = "/kaggle/working/gemma4_car_repair_adapters_v1"
