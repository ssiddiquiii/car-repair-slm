...
# --- Config (PATCHED for Explicit v2 Paths) ---
@dataclass
class PostEvalConfig:
    base_model: str = "unsloth/gemma-4-E2B-it"
    
    # Sir, assuming we are in the same active session where training just finished:
    adapter_dir: str = "/kaggle/input/datasets/sameedsiddiqui0347/lora-adapters-gemma4-car-repair-v2" 
    
    # Patched to exact v2 mount path
...
# --- Load baseline artifacts (PATCHED for _v2) ---
print("=" * 60)
...
# ============================================================
# POST-EVAL CELL 4 — Load model + adapters
# ============================================================
...
# FastModel loads adapter + base together
...
# Fallback pathing
RESULTS = Path("/kaggle/working/post_eval_results")
POSTEVAL_SCORES_PATH = RESULTS / "post_eval_scores.json"
